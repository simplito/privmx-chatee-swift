...
public struct LoadingIndicator: View {
  ...
  public var body: some View {
    ...
    Icon(size: 25, icon: "loader-2", color: ColorProviderTool.def.buttonBackgrouund(colorScheme))
...
public struct MyLoadingIndicationLight: View {
  ...
  public var body: some View {
    ...
    Icon(size: 25, icon: "loader-2", color: ColorProviderTool.def.buttonFront(colorScheme))
